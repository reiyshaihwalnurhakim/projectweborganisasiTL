...
import { createPosition } from '@/actions/structure.actions'

export default function PositionFormModal({ isOpen, onClose, positions }: { isOpen: boolean, onClose: () => void, positions: any[] }) {
    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
      <div className="bg-white rounded-2xl w-full max-w-md shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        <div className="p-5 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
          <h2 className="text-lg font-bold text-gray-900">Tambah Jabatan Baru</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">Pilih posisi atasan dari jabatan baru ini dalam struktur pohon.</p>
          </div>
